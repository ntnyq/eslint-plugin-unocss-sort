...
/**
 * Whitespace behavior used when rebuilding a sorted class list
 */
export type WhitespaceMode = 'preserve' | 'collapse'
...
export interface SortOptions {
  ...
  /**
   * Whether existing whitespace is retained or collapsed after sorting
   */
